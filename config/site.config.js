...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'toys@toyang.onmicrosoft.com',
  ...
  protectedRoutes: ['/Test', '/🥟 Some test files/Protected route'],
